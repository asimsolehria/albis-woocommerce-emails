...
<p><?php esc_html_e('The following note has been added to your order:', 'email'); ?></p>

<blockquote><b><?php echo wpautop(wptexturize(make_clickable($customer_note))); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped 
				?></b></blockquote>

<p><?php esc_html_e('Thank you very much for your acknowledgement:', 'email'); ?></p>
